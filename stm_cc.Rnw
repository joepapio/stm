...
<<examples2, echo=FALSE, warning=FALSE, message=FALSE, verbose=FALSE>>=
ex1f
ex2f
...
The resultant document feature matrix for the xkcd data set consists of 1265 rows, one for each document, and 2863 columns, one for each non trimmed n-gram remaining in the vocabulary. 
